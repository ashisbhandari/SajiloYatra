...
urlpatterns = [
    ...
    path('search_vech/', views.search_vech, name='vechile search'),
    ...
    path('seat/', views.seat, name='seat_page'),
    path('seats/<str:vehicle_no>/', views.seat, name='seats_page'),
    path('check/<int:ticket_id>/', views.map, name='map'),
    path('payment/', views.payment, name='payment for ticket'),
